 ...
 * This handles session refresh and authentication state
 */
export async function updateSession(request: NextRequest) {
  ...
  if (!supabaseUrl || !supabaseAnonKey) {
    console.warn('Supabase environment variables not set, skipping session handling')
  ...
  // Authentication is optional - users can use the app without logging in
